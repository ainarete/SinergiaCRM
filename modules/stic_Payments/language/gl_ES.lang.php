...
$mod_strings = array(
    ...
    'LBL_HOMEPAGE_TITLE' => 'Os meus Pagos',
    'LNK_NEW_RECORD' => 'Crear Pago',
    'LNK_LIST' => 'Ver Pagos',
    'LNK_IMPORT_STIC_PAYMENTS' => 'Importar Pagos',
    'LBL_SEARCH_FORM_TITLE' => 'Buscar Pagos',
    'LBL_HISTORY_SUBPANEL_TITLE' => 'Historial',
    'LBL_ACTIVITIES_SUBPANEL_TITLE' => 'Actividades',
    'LBL_STIC_PAYMENTS_SUBPANEL_TITLE' => 'Pagos',
    'LBL_NEW_FORM_TITLE' => 'Novo Pago',
    'LBL_AMOUNT' => 'Importe',
    'LBL_STATUS' => 'Estado',
    'LBL_C19_REJECTED_REASON' => 'Motivo de devolución C19',
    ...
    'LBL_TRANSACTION_CODE' => 'Codigo de transacción',
    'LBL_M182_EXCLUDED' => 'Excluir do M182',
    'LBL_MANDATE' => 'Mandato',
    'LBL_SEPA_REJECTED_REASON' => 'Motivo de devolución SEPA',
    'LBL_BANKING_CONCEPT' => 'Concepto do recibo',
    'LBL_REJECTION_DATE' => 'Data de devolución',
    ...
    'LBL_STIC_PAYMENTS_STIC_REGISTRATIONS_FROM_STIC_REGISTRATIONS_TITLE' => 'Inscrición',
    'LBL_STIC_PAYMENTS_STIC_REMITTANCES_FROM_STIC_REMITTANCES_TITLE' => 'Remesa',
    'LBL_STIC_PAYMENTS_CONTACTS_FROM_CONTACTS_TITLE' => 'Persoa',
    'LBL_STIC_PAYMENTS_ACCOUNTS_FROM_ACCOUNTS_TITLE' => 'Organización',
    'LBL_STIC_PAYMENTS_ACTIVITIES_CALLS_FROM_CALLS_TITLE' => 'Actividades: Chamadas',
    'LBL_STIC_PAYMENTS_ACTIVITIES_EMAILS_FROM_EMAILS_TITLE' => 'Actividades: Correos electrónicos',
    'LBL_STIC_PAYMENTS_ACTIVITIES_MEETINGS_FROM_MEETINGS_TITLE' => 'Actividades: Reunións',
    'LBL_STIC_PAYMENTS_ACTIVITIES_NOTES_FROM_NOTES_TITLE' => 'Actividades: Notas',
    'LBL_STIC_PAYMENTS_ACTIVITIES_TASKS_FROM_TASKS_TITLE' => 'Actividades: Tarefas',
    'LBL_STIC_PAYMENTS_STIC_ATTENDANCES_FROM_STIC_ATTENDANCES_TITLE' => 'Asistencias',
    'LBL_DEFAULT_PANEL' => 'Datos xerais',
    'LBL_PANEL_RECORD_DETAILS' => 'Detalles do rexistro',
    'LBL_RETURN_PANEL' => 'Devolución',
    'LBL_CALL_SUBJECT' => 'Xestión do impago',
    'LBL_M182_TITLE' => 'Modelo 182',
    'LBL_M182_BACK' => 'Reiniciar',
    ...
    'LBL_ADD_PAYMENTS_TO_REMITTANCE_BUTTON_LABEL' => 'Agregar á remesa',
    'LBL_CARD_PAYMENT_ALREADY_PAID' => 'Non se procesará o pago porque xa figura como pagado.',
    'LBL_CARD_PAYMENT_COMMITMENT_EXPIRED' => 'Estableceuse data de baixa para o compromiso de pago porque ao intentar realizar un pago recurrente recibiuse un erro de tarxeta caducada.',
    ...
    'LBL_AGGREGATED_SUMMARY_INCLUDED_PAYMENTS' => 'Pagos incluidos',
    'LBL_AGGREGATED_SUMMARY_COMPLETE_PAYMENTS' => 'Pagos completados',
    'LBL_AGGREGATED_SUMMARY_UNCOMPLETE_PAYMENTS' => 'Pagos non completados',
    'LBL_AGGREGATED_SUMMARY_WARNING_PAYMENTS' => 'Pagos con alerta',
    'LBL_AGGREGATED_SUMMARY_INCLUDED_ATTENDANCES' => 'Asistencias incluidas',
    'LBL_AGGREGATED_SUMMARY_PROCESSED_ATTENDANCES' => 'Asistencias procesadas',
    'LBL_AGGREGATED_SUMMARY_WARNING_ATTENDANCES' => 'Asistencias con alerta',
    'LBL_AGGREGATED_WARNING_LOG_ATTENDANCES_TITLE' => 'Asistencias con alerta',
    'LBL_AGGREGATED_WARNING_LOG_PAYMENTS_TITLE' => 'Pagos con alerta',
    'LBL_AGGREGATED_SUMMARY_TITLE_INFO' => '<b>- Pagos incluidos:</b> número de pagos de tipo <i>Servizos agregados</i>, que teñen <i>Data de pago</i> do mes actual e <i>Estado</i> diferente de <i>Pagado</i>. Un pago incluido pode terminar o proceso como <i>completado</i>, <i>non completado</i> ou <i>con alerta</i>. Polo tanto, este valor debe ser igual á suma dos tres valores seguintes.<br><br>
<b>- Pagos completados:</b> número de pagos nos que todas as súas asistencias vinculadas  puideron ser procesadas correctamente.<br><br>
<b>- Pagos non completados:</b> número de pagos nos que polo menos unha das súas asistencias vinculadas non puido ser procesada correctamente porque non ten valor nin en <i>Estado</i> nin en <i>Excepción de pago</i>. Estas asistencias aparecen no cadro <i>Asistencias con alerta</i>.<br><br>
<b>- Pagos con alerta:</b> número de pagos que no tienen ninguna asistencia vinculada para el período a analizar o ninguna inscripción vinculada en general. Estos pagos aparecen no cuadro <i>Pagos con alerta</i>.<br><br>
<b>- Asistencias incluidas:</b> número de asistencias vinculadas a pagos de <i>Servizos agregados</i> que teñen data dentro do período a analizar. Unha asistencia incluida pode terminar o proceso como <i>procesada</i> ou <i>con alerta</i>. Polo tanto, este valor debe ser igual á suma dos dos valores seguintes.<br><br>
...
<b>- Asistencias con alerta:</b> número de asistencias que non puideron ser contabilizadas dentro dos seus pagos de referencia porque non teñen valor nin en <i>Estado</i> nin en <i>Excepción de pago</i>. Estas asistencias aparecen no cadro <i>Asistencias con alerta</i>.<br><br>',
    ...
    'LBL_AGGREGATED_NOTIFICATION_BUTTON_SENDING' => 'Enviando',
    'LBL_AGGREGATED_NOTIFICATION_BUTTON_SENT' => 'Enviado',
